...
const StateList = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: ({ row }) => <div className="text-[13px] font-medium">{row.getValue("State Name")}</div>,
      size: 150,
    },
    ...
    },
    {
      ...
      id: "Zone",
      header: "Zone",
      cell: ({ row }) => <div className="text-xs font-medium">{row.getValue("Zone")}</div>,
      size: 120,
    },
    {
      accessorKey: "id",

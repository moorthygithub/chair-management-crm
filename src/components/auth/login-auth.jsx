...
export default function LoginAuth() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      const { access_token, token_type,expires_at, user ,version} = apiData;
      ...
      Cookies.set("token-expire-time", expires_at, cookieOptions);
      ...
      Cookies.set("user_type_id", user.user_type_id, cookieOptions);

...
const ProductList = () => { 
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: ({ row }) => <div className="text-[13px] font-medium">{row.getValue("Product Name")}</div>,
      size: 150,
    },
    {
      ...
      id: "Product Code",
      header: "Product Code",
      cell: ({ row }) => <div className="text-xs font-medium">{row.getValue("Product Code")}</div>,
      size: 120,
    },
    {
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return <div className="text-xs font-medium">₹{parseFloat(price).toLocaleString('en-IN')}</div>;
      },
      size: 100,
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return <div className="text-xs font-medium">{shortDescription}</div>;
      },
      size: 150,
    },
    {
